...
def run_embedding(
    ...
    embedding_model.load_state_dict({'weights':weights})
...
def run_multihead_self_attention(
    ...
    """
    mlt_atten=MultiHeadAtten(d_model,num_heads)
    ...
    return mlt_atten.forward(in_features)
...
def run_transformer_lm(
    ...
    #print(transformer_lm.state_dict().keys())
    new_weights_dict=convert_transformer_lm_weights(weights)
    transformer_lm.load_state_dict(new_weights_dict)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    try:
        ...
        voc_fre=file_to_tokens_freq(input_path,num_processes,special_tokens)
        vocab,merge=train_BPE(voc_fre,vocab_size,special_tokens)
        return vocab,merge
